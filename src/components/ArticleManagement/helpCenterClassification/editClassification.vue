  ...
  <div class="user-container">
    <div class="user-box">
      <div class="box-center">
        ...
        <div class="foot">
          <div class="btn fl" @click="updateData">{{confirmTxt}}</div>
...
export default {
  ...
  methods: {
    ...
    turn() {
      this.$router.push("/articleManagement/helpCenterClassification");
    },
    updateData() {
      var id = this.$route.params.id;
      this.$http
        .post(
          "" + this.URL.url + "/api/admin/helpCategory/update",
          "id=" + id + "&name=" + this.sortName + ""
        )
        .then(
          response => {
    ...
    getData() {
      var id = this.$route.params.id;
      this.$http
        .get("" + this.URL.url + "/api/admin/helpCategory/edit?id=" + id + "")
        .then(
          response => {
            console.log("请求成功", response.data);
            if (response.data.errmsg == null) {
              this.$Message.success("编辑数据成功");
              this.sortName = response.data.data.name;
            } else {
