    ...
    <div class="user-box">
      <div class="box-center">
        ...
        <div class="cont fl">
          ...
          <div class="btn" style="background: #35A8FF;border:1px solid #35A8FF;" @click="addData">{{confirmTxt}}</div>
          <div
            class="btn"
...
export default {
  ...
  methods: {
    ...
    turn() {
      this.$router.push("/articleManagement/helpCenterList");
    },
    addData() {
      this.$http
        .post(
          "" + this.URL.url + "/api/admin/helpEssay/add",
