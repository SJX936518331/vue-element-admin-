      ...
      <div class="box-center fl">
        ...
        <div class="cont fl">
          ...
          <div class="con">
            ...
            <div style="display: inline-block;text-align: left;width: 60%;">
              <!-- <img id="myimg" style="vertical-align: middle;" :src="ImigUrl" alt @click="showCk">
              <input
                type="file"
                name="fileToUpload"
                id="fileToUpload"
          ...
          <div class="con">
            ...
            <div style="display: inline-block;text-align: left;width: 60%;">
              <input
                ...
                v-model="shapeChoose"
              >
              <label style="margin-right: 10px;" for="0">{{Parallel}}</label>
              <input
                style="margin-right: 10px;width: 16px;height: 16px;"
                type="radio"
                name="vertical"
                ...
                v-model="shapeChoose"
              >
              <label style="margin-right: 10px;" for="1">{{Vertical}}</label>
            </div>
          </div>
          ...
          <div class="btn" @click="addData">{{submitTxt}}</div>
        </div>
      </div>
      <div class="clear"></div>
    </div>
...
export default {
  ...
  methods: {
    ...
    addData() {
      ...
      this.$http
        .post(
          "" + this.URL.url + "/api/admin/adposition/save",
          "adName=" +
            this.advertiseName +
            "&connection=" +
            this.outline +
        ...
        .then(
          response => {
            if (response.data.errmsg == null) {
              this.$notify.success("添加占位广告成功");
              this.$router.push({
                path: "/marketingManagement/generalPAM"
              });
            } else {
              this.$Message.error("添加占位广告失败");
            }
