      ...
      <div class="hd">
        <ul>
          ...
          <li class="fl">
            ...
            <div class="text fl text_chose">{{c4}}</div>
          </li>
          <li class="fl">
            <div class="logo_  fl">{{txt}}</div>
    ...
    <div class="user-box">
      <!-- <div class="user_aside fl">
        <ul>
          ...
          <li class="border-first">
            <div class="logo_  fl">{{txt}}</div>
            <div class="text fl">{{c9_}}</div>
            <div class="clear"></div>
          </li>
          <li class="border-first">
            <div class="logo_  fl">{{txt}}</div>
            <div class="text fl">{{c10_}}</div>
            <div class="ps"></div>
            <div class="clear"></div>
          </li>
      ...
      <div class="box-center">
        ...
        <div class="cont">
          ...
          >
            ...
            <el-form-item class="fl" prop="advertisingName">
              <div class="input fl">
                <span>{{advertisingNameTxt}}</span>
                <el-input
                  style="width:70%;"
                  type="text"
                  name="advertisingName"
                  v-model="formItem.advertisingName"
                />
              </div>
            </el-form-item>
        ...
        <div style="position: relative;" class="table">
          ...
          >
            ...
            <el-table-column prop="adName" label="广告名称" width="150" align="center"></el-table-column>
            <el-table-column prop="picture" label="首页图片" width="100" align="center">
            ...
            <el-table-column prop="connection" label="外链" width="200" align="center"></el-table-column>
            <el-table-column prop="order" label="排序" width="100" align="center"></el-table-column>
...
export default {
  name: "user",
  data() {
    const validateAdvertisingName = (rule, value, callback) => {
      // if (value == "") {
        ...
        advertisingName: [
          {
            required: true,
            trigger: "blur",
            validator: validateAdvertisingName
          }
        ]
      },
      formItem: {
  ...
  methods: {
    ...
    chooseData() {
      this.$http
        .get(
          "" +
            this.URL.url +
            "/api/admin/adposition/list?adName=" +
            this.formItem.advertisingName +
            ""
        )
        .then(
          response => {
            ...
            if (response.data.errmsg == null) {
              ...
              for (var i = 0; i < dataArr.length; i++) {
                this.custList.push({
                  id: dataArr[i].id,
                  adName: dataArr[i].adName,
                  picture: dataArr[i].picture,
                  shape: dataArr[i].shape,
                  type: dataArr[i].type,
                  connection: dataArr[i].connection,
                  order: dataArr[i].order,
    ...
    removeData() {
      ...
      this.$http
        .post(
          "" + this.URL.url + "/api/admin/adposition/delete",
          "ids=" + ids + ""
        )
        .then(
          response => {
    ...
    refreshData() {
      this.$http
        .get(
          "" +
            this.URL.url +
            "/api/admin/adposition/list?pageNum=" +
            this.currentPage +
            "&pageSize=20"
        )
        .then(
