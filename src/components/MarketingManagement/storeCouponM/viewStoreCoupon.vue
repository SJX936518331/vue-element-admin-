    ...
    <div class="user-box">
      <div class="box-center">
        ...
        <div class="cont fl">
          ...
          <div style="margin-bottom:150px;" class="btn" @click="turn">{{btnTxt}}</div>
        </div>
        <div style="position: relative;" class="table fl">
          ...
          >
            ...
            <el-table-column prop="exprieTime" label="有效期" width="100" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    paginationClick(current) {
      ...
      this.$http
        .get(
          "" +
            this.URL.url +
            "/api/admin/shopcouponrecord/list?pageNum=" +
            this.currentPage +
            "&pageSize=20"
        )
        .then(
    ...
    turn() {
      this.$router.push("/marketingManagement/storeCouponM");
    },
    getData() {
      var id = this.$route.params.id;
      this.$http
        .get("" + this.URL.url + "/api/admin/shopcoupon/info?id=" + id + "")
        .then(
          response => {
            console.log("请求成功", response.data);
            if (response.data.errmsg == null) {
              ...
              this.c19 = response.data.data.shopCode;
              this.c21 = response.data.data.shopName;
              this.c23 = response.data.data.couponName;
              this.c25 = response.data.data.decrease;
              this.c27 = response.data.data.amount;
              this.c29 = response.data.data.promotion;
              this.c31 = response.data.data.startDate;
              this.c33 = response.data.data.endDate;
              this.c35 = response.data.data.limited;
              this.c37 = response.data.data.collected;
              this.c39 = response.data.data.used;
            }
          },
          response => {
            this.$Message.error("系统出错");
