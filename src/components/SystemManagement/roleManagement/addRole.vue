...
export default {
  ...
  methods: {
    ...
    addData() {
      var authorities = [];
      for (var i = 0; i < this.authArr.length; i++) {
        console.log('authArr11111',this.authArr[i].value);
         if( this.authArr[i].check == true ){
             authorities.push(this.authArr[i].value);
