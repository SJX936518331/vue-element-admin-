      ...
      <div class="box-center fl">
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="favoriteCount" label="店铺数量" width="100" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    chooseData() {
      ...
      this.$http
        .get(
          "" +
            this.URL.url +
            "/api/admin/favoriteShop/list?pageNum=" +
            this.currentPage +
            "&pageSize=20&isVip=" +
            value +
            "&userName=" +
          ...
          response => {
            ...
            for (var i = 0; i < dataArr.length; i++) {
              ...
              this.custList.push({
                ...
                favoriteCount: dataArr[i].favoriteCount
              });
            }
    ...
    showDetail() {
      this.$router.push("/userShopCollection/edit");
    },
    request() {
      this.$http
        .get(
