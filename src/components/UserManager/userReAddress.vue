      ...
      <div class="box-center fl">
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="addressCount" label="地址数" width="100" align="center"></el-table-column>
    ...
    chooseData() {
      ...
      this.$http
        .get(
          "" +
            this.URL.url +
            "/api/admin/memberAddress/list?pageNum=" +
            this.currentPage +
            "&pageSize=20&isVip=" +
            value +
            "&userName=" +
          ...
          response => {
            ...
            for (var i = 0; i < dataArr.length; i++) {
              ...
              this.custList.push({
                ...
                addressCount: dataArr[i].addressCount
              });
            }
        ...
        if (valid) {
          this.$http
            .get(
              "" +
                this.URL.url +
                "/api/admin/memberAddress/list?pageNum=1&pageSize=1"
            )
            .then(
              response => {
